<div class="filter">
  ...
  <li class="dropdown dropdown-inline">
    ...
    <ul class="dropdown-menu">
        ...
        <li>
          <a href="{{ route('routines.index', array_merge(Request::all(), ['group_id' => $routine_group->id, 'filter_by' => 'deleted-items', 'deleted-items' => 'Only Deleted'])) }}">
            Only Deleted
          </a>
        </li>
        <li>
          <a href="{{ route('routines.index', array_merge(Request::all(), ['group_id' => $routine_group->id, 'filter_by' => 'deleted-items', 'deleted-items' => 'All'])) }}">
            All
          </a>
        </li>
    </ul>
  ...
  <div class="show-records">
    <li class="dropdown dropdown-inline">
      ...
      <ul class="dropdown-menu">
          ...
          <li>
              <a href="{{ route('routines.index', array_merge(Request::all(), ['group_id' => $routine_group->id, 'show-items' => 25])) }}">
                25 records
              </a>
          </li>
          <li>
              <a href="{{ route('routines.index', array_merge(Request::all(), ['group_id' => $routine_group->id, 'show-items' => 50])) }}">
                50 records
              </a>
          </li>
          <li>
              <a href="{{ route('routines.index', array_merge(Request::all(), ['group_id' => $routine_group->id, 'show-items' => 100])) }}">
                100 records
              </a>
          </li>
          <li>
              <a href="{{ route('routines.index', array_merge(Request::all(), ['group_id' => $routine_group->id, 'show-items' => $total_routine])) }}">
                All
              </a>
          </li>
      </ul>
