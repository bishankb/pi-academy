...
class ExaminationResultController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:view_student_registrations', ['only' => ['studentList', 'studentShow']]);
        $this->middleware('permission:view_examination_results', ['only' => ['index', 'show']]);
    }

    public function studentList()
    {
        $students = StudentRegistration::search(request('search-item'))
                        ->whereHas('examinationRecords')
        ...
        $total_student = StudentRegistration::whereHas('examinationRecords')->count();

        return view('backend.examination-result.student-list', compact('students', 'education_levels', 'interested_courses', 'total_student'));
    }
    ...
    public function studentShow($id)
    {
        ...
        return view('backend.examination-result.student-show', compact('totalAttempted_question_separate'));
    }
    ...
    {
        $examination_results = ExaminationResult::where('student_id', $student_id)
        ...
        $total_examination_result = ExaminationResult::where('student_id', $student_id)->count();
        
        return view('backend.examination-result.examination-record.index', compact('examination_results', 'student', 'question_sets', 'total_examination_result'));
    }
    ...
    {
        $student = StudentRegistration::find($student_id);
        $examination_result = ExaminationResult::where('student_id', $student_id)->find($id);
        ...
        return view('backend.examination-result.examination-record.show', compact('examination_result', 'student', 'attempted_question_answers', 'attempted_question_separate'));
    }
