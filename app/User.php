...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany(Attendence::class, 'staff_id')->withTrashed();
    }
    ...
    protected static function boot() {
        ...
        static::deleting(function($user) {
            if ($user->isForceDeleting()) {
                ...
                $user->attendences()->withTrashed()->forceDelete();
            } else {
                $user->profile()->delete();
                $user->attendences()->delete();
            }
        });

        static::restoring(function ($user) {
            $user->profile()->withTrashed()->restore();
            $user->attendences()->withTrashed()->restore();
        });
    }
}
